...
export default function StudyCyclePage() {
  ...
  return <div className="space-y-6 animate-fade-in">
    ...
    {!activeCycle ? <div className="glass rounded-sm p-10 text-center border border-primary/15">
    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogContent className="max-h-[90vh] overflow-hidden sm:max-w-3xl">
        ...
        <div className="space-y-4 pt-2">
          ...
          <div className="max-h-[48vh] overflow-y-auto rounded-sm border border-border divide-y divide-border">
